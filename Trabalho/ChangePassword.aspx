<%@ Page Title="Mudar a palavra passe" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="ChangePassword" %>
                    ...
                    <ChangePasswordTemplate>
                        <table class="table table-condensed">
                            <thead>
                                <th>
                                    <td colspan="3">
                                        <label class="control-label">Alterar a palavra passe </label>
                                    </td>
                                </th>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:Label runat="server" CssClass="control-label" AssociatedControlID="CurrentPassword" ID="CurrentPasswordLabel">Palavra passe:</asp:Label></td>
                                    </td>
                                    <td>
