...
public partial class BibliotecaEntity : DbContext
{
    ...
    public virtual DbSet<Table_Autor> Autores { get; set; }
    public virtual DbSet<Table_Categoria> Categorias { get; set; }
    public virtual DbSet<Table_Editora> Editoras { get; set; }
    public virtual DbSet<Table_Livro> Livros { get; set; }
    public virtual DbSet<Table_Utilizador> Utilizadores { get; set; }
    public virtual DbSet<Table_UtilizadorLivro> UtilizadoresLivros { get; set; }
    public virtual DbSet<View_Livro> View_Livro { get; set; }
    public virtual DbSet<view_utilizador_req_livro> ViewUtilizadoresReqLivro { get; set; }
