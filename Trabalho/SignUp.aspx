...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
    <div id="animWrapper">
        ...
        <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" ContinueDestinationPageUrl="~/Perfil.aspx" ContinueButtonStyle-CssClass="btn btn-success" ContinueButtonType="Link" CancelButtonType="Link" CancelDestinationPageUrl="~/Default.aspx" CreateUserButtonType="Link" DisplayCancelButton="True" Font-Names="Verdana" Font-Size="10pt">
                ...
                <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server">
                    <ContentTemplate>
                        <table class="table table-condensed">
                            <th>
                                <td colspan="3">
                                    <h2 class="control-label text-center">Sign Up for Your New Account</h2>
                                </td>
                            </th>
                            <tr>
                                <td>
                                    <asp:Label ID="UserNameLabel" CssClass="control-label pull-right" runat="server" AssociatedControlID="UserName">User Name:</asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="UserName" CssClass="form-control" runat="server"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator CssClass="control-label pull-left" ID="UserNameRequired" runat="server" ControlToValidate="UserName" ErrorMessage="User Name is required." ToolTip="User Name is required." ValidationGroup="CreateUserWizard1">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="ConfirmPasswordLabel" CssClass="control-label pull-right" runat="server" AssociatedControlID="ConfirmPassword">Confirm Password:</asp:Label>
                                </td>
                                <td>
