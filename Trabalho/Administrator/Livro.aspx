...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <asp:TemplateField HeaderText="Autor" SortExpression="Autor">
                                <EditItemTemplate>
                                    ...
                                    <asp:DropDownList ID="DropDownList4"
                                        ...
                                        CssClass="form-control"
                                        SelectedValue='<%# Bind("Autor") %>' runat="server" DataSourceID="Autor">
                                    </asp:DropDownList>
                                </EditItemTemplate>
                                <ItemTemplate>
    ...
    <asp:SqlDataSource runat="server" 
        ...
        InsertCommand="INSERT INTO [Table_Livro] ([ISBN], [Titulo], [Data_Publicacao], [Categoria], [Editora], [Autor]) VALUES (@ISBN, @Titulo, @Data_Publicacao, @Categoria, @Editora, @Autor)" 
        SelectCommand="SELECT * FROM [Table_Livro] ORDER BY [Titulo]" 
        UpdateCommand="UPDATE [Table_Livro] SET [ISBN] = @ISBN, [Titulo] = @Titulo, [Data_Publicacao] = @Data_Publicacao, [Categoria] = @Categoria, [Editora] = @Editora, [Autor] = @Autor WHERE [ID_Livro] = @ID_Livro">
        <DeleteParameters>
